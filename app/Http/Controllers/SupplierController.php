...
class SupplierController extends Controller
{
    ...
    // menambah supplier baru menggunakan ajax
    ...
    // menampilkan detail user menggunakan ajax
    ...
    // fungsi untuk menyimpan data supplier yang telah diubah menggunakan ajax
