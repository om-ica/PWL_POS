<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Tambah Penjualan Baru</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
            </button>
        </div>
        <div class="modal-body">
            <form id="form-tambah-penjualan">
                @csrf
...
<script>
    ...
    // Reset form dan tabel saat konten modal dimuat
    $(document).ready(function() {
        // Reset form dan tabel
        const form = $('#form-tambah-penjualan');
        if (form.length) {
            form[0].reset();
        }
        ...
        itemCounter = 0;
        addItem(); // Tambah satu baris kosong secara default
